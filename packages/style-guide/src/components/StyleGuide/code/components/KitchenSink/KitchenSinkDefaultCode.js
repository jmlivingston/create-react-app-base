const KitchenSinkDefaultCode = `import React, { Fragment, PureComponent } from 'react'
...
class KitchenSinkDefault extends PureComponent {
  state = {
...
export default KitchenSinkDefault
`

export default KitchenSinkDefaultCode
