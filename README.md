...
- [node - >=7.6.0 <10.0.0](https://nodejs.org/en)
- [yarn](https://yarnpkg.com)

## Installation

After cloning run `yarn` in the terminal to install the required npm packages.
...
Currently using level 9 GZIP compression. This makes a huge impact on production performance. See deploy/server/serve.js code to see how this is wired up in a node Express app. If using alternatives like IIS, Apache, etc., you will need to configure accordingly.
...
- [dayjs](https://github.com/iamkun/dayjs) - Very lightweight date library used by our date helper code. Note: This is redundant with moment, but moment is required by the react-datepicker component. The code in date helper can be replaced with moment, though you'll want to be careful as moment is notoriously huge. See the common DatePicker component to see how we dynamically import moment
- [loaders.css](https://connoratherton.com/loaders) - Lightweight CSS loader library used in our Loader component. You can update the default by changing LOADER_NAME in APP.js
