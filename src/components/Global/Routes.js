  ...
  <BrowserRouter>
    <Switch>
      ...
      <Route
        ...
        component={Loadable({
          loading: () => <Loader message={`${strings.loading} ${strings.routes.languageTester.displayName}...`} />,
      ...
      <Route
        ...
        component={Loadable({
          ...
          render(loaded, props) {
            ...
            return <SiteMap strings={strings} />
          }
        })}
      />
      <Route
      ...
      <Route
        ...
        component={Loadable({
          loading: () => <Loader message={`${strings.loading} ${strings.routes.userSettings.displayName}...`} />,
